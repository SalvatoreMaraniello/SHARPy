...
def init_GEBM_tensors(NumDof,Nconstr):
    '''
    ...
    Q     = np.zeros(NumDof.value+6+4+Nconstr, ct.c_double, 'F')
    DQ    = np.zeros(NumDof.value+6+4+Nconstr, ct.c_double, 'F')
    dQdt  = np.zeros(NumDof.value+6+4+Nconstr, ct.c_double, 'F')
    dQddt = np.zeros(NumDof.value+6+4+Nconstr, ct.c_double, 'F')
    Force_All = np.zeros(NumDof.value+6, ct.c_double, 'F')

    Msys = np.zeros((NumDof.value+6+4+Nconstr,NumDof.value+6+4+Nconstr), ct.c_double, 'F')
    Csys = np.zeros((NumDof.value+6+4+Nconstr,NumDof.value+6+4+Nconstr), ct.c_double, 'F') 
    Ksys = np.zeros((NumDof.value+6+4+Nconstr,NumDof.value+6+4+Nconstr), ct.c_double, 'F') 
    Asys = np.zeros((NumDof.value+6+4+Nconstr,NumDof.value+6+4+Nconstr), ct.c_double, 'F')
    
    Qsys = np.zeros(NumDof.value+6+4+Nconstr, ct.c_double, 'F')
...
def lagsolver(M, Q, NumDof, MinTol=1e-3, MaxIter=1):
    '''
    ...
    iirig=[ii for ii in range(NumDof,NumTot)] # these may iclude constraints eq.
